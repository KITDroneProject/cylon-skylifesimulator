...
AFRAME.registerComponent('dronesimulator', {
			...
			forward: function forward(speed) {
						this.move([0, this.PIDControl(this.target_height), -speed]);
			},
			backward: function backward(speed) {
						this.move([0, this.PIDControl(this.target_height), speed]);
			},
			...
			clockwise: function clockwise(speed) {
						this.rotate(-speed);
						this.move([0, this.PIDControl(this.target_height), 0]);
			},
			counterClockwise: function counterClockwise(speed) {
						this.rotate(speed);
						this.move([0, this.PIDControl(this.target_height), 0]);
			},
			...
			PIDControl: function PIDControl(target) {
						return this.kp * (target - this.drone.body.position.y);
			},
			quatToVec3: function quatToVec3(x, y, z, w) {
...
const DroneSim = new DroneSimulator(
    document.querySelector('a-scene'),
    document.querySelector('#simdrone')
)
;
			...
			return regeneratorRuntime.wrap(function _callee$(_context) {
						while (1) {
									switch (_context.prev = _context.next) {
												...
												case 4:
															drone = document.querySelector("#simdrone");
...
},{"babel-polyfill":2,"co":3}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":4,"core-js/shim":297,"regenerator-runtime/runtime":299}],3:[function(require,module,exports){
